...
class DefaultApi(object):
        ...
        self.station_overview_extended_get_endpoint = _Endpoint(
            ...
            root_map={
                ...
                "attribute_map": {
                    ...
                    "stations_kennungen": "stationsKennungen",
                },
                "location_map": {
                    "station_ids": "query",
                    "stations_kennungen": "query",
                },
                "collection_format_map": {
                    "station_ids": "csv",
                    "stations_kennungen": "csv",
                },
            },
            headers_map={
                "accept": ["application/json"],
    ...
    def station_overview_extended_get(self, **kwargs):
        ...
        Keyword Args:
            station_ids ([bool, date, datetime, dict, float, int, list, str, none_type]): Der Parameter stationIds wird in stationsKennungen umbenannt. Daher ist stationIds als veraltet markiert und wird in einer zukünftigen Version werden. Bitte nur noch den Parameter stationsKennungen verwenden. . [optional]
            stations_kennungen ([bool, date, datetime, dict, float, int, list, str, none_type]): Stationskennungen könen z.B. [hier](https://www.dwd.de/DE/leistungen/klimadatendeutschland/stationsliste.html) eingesehen werden. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
