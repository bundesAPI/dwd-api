...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.gemeinde_warnings_v2_json_get_endpoint = _Endpoint(
            settings={
                "response_type": (GemeindeWarnings,),
                "auth": [],
                "endpoint_path": "/gemeinde_warnings_v2.json",
                "operation_id": "gemeinde_warnings_v2_json_get",
                "http_method": "GET",
                "servers": [
                    {
                        "url": "https://s3.eu-central-1.amazonaws.com/app-prod-static.warnwetter.de/v16",
    ...
    def gemeinde_warnings_v2_json_get(self, **kwargs):
        """Gemeinde Unwetterwarnungen (Deutsch)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.gemeinde_warnings_v2_json_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        return self.gemeinde_warnings_v2_json_get_endpoint.call_with_http_info(**kwargs)
    ...
    def station_overview_extended_get(self, **kwargs):
        ...
        Keyword Args:
            station_ids ([StationOverviewExtendedGetStationIdsParameterInner]): Beim Parameter stationsIds handelt es sich um die Stationskennungen des DWD. Die Liste der Stationskennungen kann z.B. [hier](https://www.dwd.de/DE/leistungen/klimadatendeutschland/stationsliste.html) eingesehen werden.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
